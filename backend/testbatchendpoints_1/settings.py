"""
Django settings for testbatchendpoints_1 project.
...
ROOT_URLCONF = 'testbatchendpoints_1.urls'
...
WSGI_APPLICATION = 'testbatchendpoints_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testbatchendpoints_1 API",
    "DESCRIPTION": "API documentation for testbatchendpoints_1 App",
    "VERSION": "v1",
}
