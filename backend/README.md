...
## Project Structure
    ...
    ├── testbatchendpoints_1  # Django project configurations
...
1. Clone this repo and `cd testbatchendpoints_1`
...
2. Clone this repo and `cd testbatchendpoints_1`
